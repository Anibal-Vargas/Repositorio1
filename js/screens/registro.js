...
export async function telaRegistro(inspecaoId, equipamentoId) {
  ...
  function montarValorMedido() {
    ...
    return el(
      'section',
      { class: 'secao-registro' },
      el('h2', {}, 'Valor medido em miliohms'),
      el(
        'div',
        { class: 'item-checklist' },
        el('div', { class: 'descricao' }, 'Informe o valor medido em miliohms (obrigatório)'),
        el(
          'div',
          { class: 'campo-medicao' },
          campo,
  ...
  function montarProlongador() {
    ...
    return el(
      ...
      el(
        ...
        el('div', { class: 'campo-medicao' }, campo, el('span', { class: 'unidade' }, 'mΩ'))
      )
    );
  }
  ...
  return [
    ...
    el(
      ...
      { class: 'conteudo' },
      secoesFotos,
      el('section', { class: 'secao-registro' }, el('h2', {}, '04 · Gravar áudio (opcional)'), listaAudios, !somenteLeitura ? botaoGravar : null),
      el(
        'section',
        { class: 'secao-registro' },
        el('h2', {}, '05 · Escrever observação (opcional)'),
        somenteLeitura
          ? campoObservacao
